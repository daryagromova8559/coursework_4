...
def test_init2(vac):
    ...
    assert vac.vacancy() == [
        {'id': '95638301', 'premium': False, 'name': 'Учитель русского языка и литературы', 'department': None,
         ...
         'adv_context': None}]
    assert vac.construction() == [
        '1.Учитель русского языка и литературы, \nЗарплата от: 100000, \nЗарплата до: 0, \nТребование: Высшее профессиональное образование или среднее профессиональное образование по направлению подготовки «Образование и педагогика» или в области, соответствующей преподаваемому предмету. , \nТребуется: Обеспечивать использование разнообразных форм, приемов, методов и средств обучения, в том числе по индивидуальным учебным планам, ускоренным курсам в рамках..., \nГород: Москва, \nСсылка на вакансию: https://hh.ru/vacancy/95638301']
    assert vac.top_vacancy() == 100000
